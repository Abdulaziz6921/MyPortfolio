...
function Navbar() {
  ...
  const stl = {
    size:
      'relative  w-[95%] h-[60px] border-2 border-red-500 mx-auto flex justify-between items-center text-white overflow-hidden lg:w-[90%] md:h-[80px] md:sticky top-0 right-0 left-0 md:z-20 ',
    name: 'text-[25px] md:text-[32px] oblique font-mono font-bold ',
    main_links:
      'hidden  lg:w-[45%] md:w-[50%] md:h-[55px] border-2 border-green-500 md:flex justify-evenly items-center ',
    li: 'w-[130px] h-full',
    li_a:
      'w-full h-full flex justify-center items-center font-[600] text-[20px] duration-400 hover:text-secondary hover:rounded-[8px] hover:bg-gradient-to-r from-[#636363] to-[#bab8b8] hover:shadow-xl    hover:duration-300',
    three_bar:
      'md:hidden w-[50px] flex justify-center items-center h-full border-2 border-green-700',
    bar: ' text-[42px]',

    arrow_icon:
      'mt-[10px] mb-[20px] ml-[5%] text-[25px] bg-[#bcfd4c] rounded-[50%]  hover:text-primary',
    img:
      'w-[140px] h-[140px] mt-[20px] mx-auto mb-[5px] rounded-full object-contain',
    profession: 'text-center text-[17px] text-primary font-[600] ',
    li_collection: 'mt-[20px] w-full h-[25%] flex flex-col justify-between',

    l_items:
      'group w-[95%] h-[65px] flex items-center justify-center rounded-r-[14px]  hover:bg-primary ',
    inner_li: 'flex justify-start items-center w-[135px] h-full ',
    ...
    } w-[50%] h-full fixed right-0 top-0 z-20 rounded-l-[25px] bg-[#bcfd4c] md:hidden duration-500`,
  }
