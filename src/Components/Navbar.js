...
function Navbar() {
  ...
  const stl = {
    size:
      'relative bg-primary w-[95%] h-[60px] border-2 border-red-500 mx-auto flex justify-between items-center text-white overflow-hidden md:h-[80px] md:sticky top-0 right-0 left-0 md:z-20 lg:w-[90%] md:z-20',
